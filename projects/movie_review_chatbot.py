...
@st.cache_data
def load_imdb_data():
    imdb_data = pd.read_csv(r'C:\Users\rajes\OneDrive\Desktop\IMDB Dataset.csv')
    return imdb_data

# Load the second IMDb dataset
@st.cache_data
def load_second_imdb_data():
    second_imdb_data = pd.read_csv(r'C:\Users\rajes\OneDrive\Desktop\25k IMDb movie Dataset.csv')
